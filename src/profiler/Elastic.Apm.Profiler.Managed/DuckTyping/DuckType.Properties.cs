...
namespace Elastic.Apm.Profiler.Managed.DuckTyping
{
	...
	public static partial class DuckType
	{
		...
		private static MethodBuilder GetPropertySetMethod(TypeBuilder proxyTypeBuilder, Type targetType, MemberInfo proxyMember,
			PropertyInfo targetProperty, FieldInfo instanceField
		)
		{
		...
		private static IEnumerable<Type> GetPropertyGetParametersTypes(TypeBuilder typeBuilder, PropertyInfo property, bool originalTypes,
			bool isDynamicSignature = false
		)
		{
		...
		private static IEnumerable<Type> GetPropertySetParametersTypes(TypeBuilder typeBuilder, PropertyInfo property, bool originalTypes,
			bool isDynamicSignature = false
		)
		{
			if (isDynamicSignature)
