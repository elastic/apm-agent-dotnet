...
namespace Elastic.Apm.Profiler.Managed.DuckTyping
{
	...
	public static partial class DuckType
	{
		...
		private static readonly ConcurrentDictionary<TypesTuple, Lazy<CreateTypeResult>> DuckTypeCache =
			new ConcurrentDictionary<TypesTuple, Lazy<DuckType.CreateTypeResult>>();
		...
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private static readonly Dictionary<ModuleBuilder, HashSet<string>> _ignoresAccessChecksToAssembliesSetDictionary =
