...
namespace Elastic.Apm.Profiler.Managed.CallTarget.Handlers
{
	internal static class BeginMethodHandler<TIntegration, TTarget, TArg1, TArg2, TArg3>
	{
		...
		static BeginMethodHandler()
		{
			...
			{
				if (_invokeDelegate is null) _invokeDelegate = (instance, arg1, arg2, arg3) => CallTargetState.GetDefault();
			}
		}
		...
		internal static CallTargetState Invoke(TTarget instance, TArg1 arg1, TArg2 arg2, TArg3 arg3) =>
			new CallTargetState(Agent.IsConfigured ? Agent.Tracer.CurrentExecutionSegment() : null, _invokeDelegate(instance, arg1, arg2, arg3));
	}
}
