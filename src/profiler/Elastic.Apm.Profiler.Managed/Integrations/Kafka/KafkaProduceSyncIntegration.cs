...
namespace Elastic.Apm.Profiler.Managed.Integrations.Kafka
{
	...
	public class KafkaProduceSyncIntegration
	{
		...
		public static CallTargetState OnMethodBegin<TTarget, TTopicPartition, TMessage, TDeliveryHandler>(TTarget instance,
			TTopicPartition topicPartition, TMessage message, TDeliveryHandler deliveryHandler
		)
