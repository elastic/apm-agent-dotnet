...
namespace Elastic.Apm.Profiler.Managed.Integrations.AdoNet
{
	...
	[InstrumentOracleManagedDataAccess(Method = ExecuteDbDataReader, ReturnType = DbDataReader,
		ParameterTypes = new[] { AdoNetTypeNames.CommandBehavior })]
	[InstrumentOracleManagedDataAccessCore(Method = ExecuteDbDataReader, ReturnType = DbDataReader,
		ParameterTypes = new[] { AdoNetTypeNames.CommandBehavior })]
	[InstrumentMicrosoftDataSqlite(Method = ExecuteDbDataReader, ReturnType = DbDataReader,
		ParameterTypes = new[] { AdoNetTypeNames.CommandBehavior })]
	...
	[InstrumentSystemDataSqlClient(Method = ExecuteDbDataReader, ReturnType = DbDataReader,
		ParameterTypes = new[] { AdoNetTypeNames.CommandBehavior })]
	[InstrumentMicrosoftDataSqlClient(Method = ExecuteDbDataReader, ReturnType = DbDataReader,
		ParameterTypes = new[] { AdoNetTypeNames.CommandBehavior })]
