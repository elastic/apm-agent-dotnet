...
namespace Elastic.Apm.Profiler.Managed.Reflection
{
	...
	internal static class ObjectExtensions
	{
		...
		private static readonly ConcurrentDictionary<PropertyFetcherCacheKey, object> Cache =
			new ConcurrentDictionary<PropertyFetcherCacheKey, object>();

		private static readonly ConcurrentDictionary<PropertyFetcherCacheKey, PropertyFetcher> PropertyFetcherCache =
			new ConcurrentDictionary<PropertyFetcherCacheKey, PropertyFetcher>();
