...
#pragma warning restore SYSLIB0014
		...
		private static HttpClientHandler CreateHttpClientHandler(IConfiguration configuration, IApmLogger logger)
		{
			...
			var serverUseWindowsCredentials = configuration.ServerUseWindowsCredentials;
			...
			return new HttpClientHandler { ServerCertificateCustomValidationCallback = serverCertificateCustomValidationCallback, UseDefaultCredentials = serverUseWindowsCredentials };
		}
