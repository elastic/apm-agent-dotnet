...
namespace Elastic.Apm.Api
{
    public interface ITransaction
    {
        ...
        /// <param name="name">The name of the span.</param>
        /// <param name="type">The type of the span.</param>
        /// <param name="capturedAction">The <see cref="Action{ISpan}"/> that points to the code that you want to capture as a span.
        ...
        /// <param name="name">The name of the span.</param>
        /// <param name="type">The type of the span.</param>
        /// <param name="func">The <see cref="Func{ISpan,T}"/> that points to the code with a return value that you want to capture as a span.
        ...
        /// <param name="name">The name of the span.</param>
        /// <param name="type">The type of the span.</param>
        /// <param name="func">The <see cref="Func{ISpan,Task}"/> that points to the async code that you want to capture as a span.
        /// The <see cref="ISpan"/> parameter gives you access to the span which is created by this method.
        /// </param>
        /// <param name="subType">The subtype of the span.</param>
        /// <param name="action">The action of the span.</param>
        ...
        /// <param name="name">The name of the span.</param>
        /// <param name="type">The type of the span.</param>
        /// <param name="func">The <see cref="Func{Task}"/> that points to the async code with a return value that you want to capture as a span.</param>
        /// <param name="subType">The subtype of the span.</param>
        /// <param name="action">The action of the span.</param>
        ...
        /// <param name="name">The name of the span.</param>
        /// <param name="type">The type of the span.</param>
        /// <param name="func">The <see cref="Func{ISpan,Task}"/> that points to the async code with a return value that you want to capture as a span.
        /// The <see cref="ISpan"/> parameter gives you access to the span which is created by this method.
        /// </param>
        /// <param name="subType">The subtype of the span.</param>
        /// <param name="action">The action of the span.</param>
