...
namespace Elastic.Apm.Api
{
    public interface IElasticApm
    {
        ...
        /// <param name="name">The name of the transaction.</param>
        /// <param name="type">The type of the transaction.</param>
        /// <param name="action">The <see cref="Action{ITransaction}"/> that points to the code that you want to capture as a transaction.
        ...
        /// <param name="name">The name of the transaction.</param>
        /// <param name="type">The type of the transaction.</param>
        /// <param name="action">The <see cref="Action{ITransaction}"/> that points to the code that you want to capture as a transaction.</param>
        ...
        /// <param name="name">The name of the transaction.</param>
        /// <param name="type">The type of the transaction.</param>
        /// <param name="func">The <see cref="Action{ITransaction}"/> that points to the code that you want to capture as a transaction.
        /// The <see cref="ITransaction"/> parameter gives you access to the transaction which is created by this method.
        /// </param>
        ...
        /// <param name="name">The name of the transaction.</param>
        /// <param name="type">The type of the transaction.</param>
        /// <param name="func">The <see cref="Action{ITransaction}"/> that points to the code that you want to capture as a transaction.</param>
        /// <typeparam name="T">The return type of the code that you want to capture as transaction.</typeparam>
        /// <returns>The result of the <param name="func"></param>.</returns>
        ...
        /// <param name="name">The name of the transaction.</param>
        /// <param name="type">The type of the transaction.</param>
        /// <param name="func">The <see cref="Func{Task}"/> that points to the async code that you want to capture as a transaction.</param>
        ...
        /// <param name="name">The name of the transaction.</param>
        /// <param name="type">The type of the transaction.</param>
        /// <param name="func">The <see cref="Func{Task}"/> that points to the async code that you want to capture as a transaction.
        /// The <see cref="ITransaction"/> parameter gives you access to the transaction which is created by this method.
        /// </param>
        /// <returns>The <see cref="Task"/> that you can await on.</returns>
        ...
        /// <param name="name">The name of the transaction.</param>
        /// <param name="type">The type of the transaction.</param>
        /// <param name="func">The <see cref="Func{Task}"/> that points to the async code with a return value that you want to capture as a transaction.</param>
        ...
        /// <param name="name">The name of the transaction.</param>
        /// <param name="type">The type of the transaction.</param>
        /// <param name="func">The <see cref="Func{Task}"/> that points to the async code with a return value that you want to capture as a transaction.
        /// The <see cref="ITransaction"/> parameter gives you access to the transaction which is created by this method.
        /// </param>
        /// <typeparam name="T">The return type of the <see cref="Task{T}"/> that you want to capture as transaction.</typeparam>
        /// <returns>The <see cref="Task{T}"/> that you can await on.</returns>
