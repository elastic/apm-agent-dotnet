...
use crate::{
    ...
    interfaces::{
        ...
        ICorProfilerObjectEnum, ICorProfilerThreadEnum, IMethodMalloc,
    },
};
...
impl ICorProfilerInfo {
    ...
    pub fn get_token_and_metadata_from_function<I: Interface>(
        &self,
        function_id: FunctionID,
    ) -> Result<FunctionTokenAndMetadata<I>, HRESULT> {
