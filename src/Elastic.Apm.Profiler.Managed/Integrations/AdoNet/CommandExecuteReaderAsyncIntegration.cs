...
namespace Elastic.Apm.Profiler.Managed.Integrations.AdoNet
{
    ...
    /// </summary>
	[InstrumentMySqlAttribute(Method = ExecuteReaderAsync, ReturnType = MySql.TaskDataReader, ParameterTypes = new[] { ClrTypeNames.CancellationToken })]
	...
	[InstrumentMicrosoftDataSqlite(Method = ExecuteReaderAsync, ReturnType = MicrosoftDataSqlite.TaskDataReader, ParameterTypes = new[] { ClrTypeNames.CancellationToken })]
	[InstrumentSystemDataSqlite(Method = ExecuteReaderAsync, ReturnType = SystemDataSqlite.TaskDataReader, ParameterTypes = new[] { ClrTypeNames.CancellationToken })]
