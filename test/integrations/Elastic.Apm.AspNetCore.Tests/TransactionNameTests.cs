...
namespace Elastic.Apm.AspNetCore.Tests
{
	...
	public class TransactionNameTests : IClassFixture<WebApplicationFactory<Startup>>, IDisposable
	{
		...
		/// </summary>
		[Fact]
		public async Task Name_Should_Be_Area_Controller_Action_When_Mvc_Area_Controller_Action_With_Area_Route()
		{
			var httpClient = Helper.GetClient(_agent, _factory);
		...
		/// </summary>
		[InlineData("home/doesnotexist")]
		[InlineData("files/doesnotexist/somefile")]
		[Theory]
		public async Task NotFoundRoute_ShouldBe_Aggregatable(string url)
		{
			var httpClient = Helper.GetClient(_agent, _factory);
		...
		/// </summary>
		[Fact]
		public async Task Http404WithValidRoute()
		{
			var httpClient = Helper.GetClient(_agent, _factory);
