...
namespace Elastic.Apm.AspNetCore.Tests
{
    ...
    public class MicrosoftExtensionsConfigTests
    {
        ...
        public void ReadInvalidLogLevelConfigFromAppsettingsJson()
        {
            ...
            Assert.Equal($"Error Config: Failed parsing log level from IConfiguration: {MicrosoftExtensionConfigConsts.LogLevel}, value: DbeugMisspelled. Defaulting to log level 'Error'", (Apm.Agent.Config.Logger as TestLogger).Lines[0]);
        }
