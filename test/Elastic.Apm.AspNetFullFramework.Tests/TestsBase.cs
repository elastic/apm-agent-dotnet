...
namespace Elastic.Apm.AspNetFullFramework.Tests
{
	public class TestsBase : IAsyncLifetime
	{
		...
		internal static class SampleAppUrlPaths
		{
			...
			internal static readonly SampleAppUrlPathData ForbidHttpResponsePage =
				new SampleAppUrlPathData(HomeController.ForbidHttpResponsePageRelativePath, 200, spansCount: 1);
