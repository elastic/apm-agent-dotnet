...
namespace Elastic.Apm.Tests.Utilities
{
	...
	internal class MockConfiguration : FallbackConfigurationBase, IConfiguration
	{
		public MockConfiguration(IApmLogger logger = null,
			...
			string apiKey = null,
			string baggageToAttachOnTransactions = null,
			string baggageToAttachOnSpans = null,
			string baggageToAttachOnErrors = null,
			...
			new MockConfigurationEnvironmentProvider(key => key switch
			{
				...
				ConfigurationOption.BaggageToAttachOnTransactions => baggageToAttachOnTransactions,
				ConfigurationOption.BaggageToAttachOnSpans => baggageToAttachOnSpans,
				ConfigurationOption.BaggageToAttachOnErrors => baggageToAttachOnErrors,
