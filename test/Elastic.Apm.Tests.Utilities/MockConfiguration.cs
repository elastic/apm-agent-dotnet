...
namespace Elastic.Apm.Tests.Utilities
{
	...
	internal class MockConfiguration : FallbackConfigurationBase, IConfiguration
	{
		public MockConfiguration(IApmLogger logger = null,
			...
			string openTelemetryBridgeAllowedActivitySources = null,
			string openTelemetryBridgeDeniedActivitySources = null,
			string openTelemetryBridgeExperimentalSourcesEnabled = null,
			...
			new MockConfigurationEnvironmentProvider(key => key switch
			{
				...
				ConfigurationOption.OpenTelemetryBridgeAllowedActivitySources => openTelemetryBridgeAllowedActivitySources,
				ConfigurationOption.OpenTelemetryBridgeDeniedActivitySources => openTelemetryBridgeDeniedActivitySources,
				ConfigurationOption.OpenTelemetryBridgeExperimentalSourcesEnabled => openTelemetryBridgeExperimentalSourcesEnabled,
