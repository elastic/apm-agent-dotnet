...
public class AzureFunctionsIsolatedTests : AzureFunctionsTestBase, IClassFixture<IsolatedContext>
{
	public AzureFunctionsIsolatedTests(ITestOutputHelper output, IsolatedContext context)
		: base(output, context) { }
