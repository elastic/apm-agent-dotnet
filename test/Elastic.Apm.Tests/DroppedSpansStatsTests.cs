...
namespace Elastic.Apm.Tests
{
	...
	public class DroppedSpansStatsTests
	{
		...
		public void SingleDroppedSpanTest()
		{
			...
			payloadSender.FirstTransaction.DroppedSpanStats.First().Duration.Sum.Us.Should().Be(100001);
		}
		...
		public void MultipleDroppedSpanTest()
		{
			...
			payloadSender.FirstTransaction.DroppedSpanStats.Should()
				.Contain(n => n.Outcome == Outcome.Success
					&& n.Duration.Count == 2 && Math.Abs(n.Duration.Sum.UsRaw - 250000) < 1 && n.DestinationServiceResource == "foo.bar:443"
					&& n.ServiceTargetName == "foo.bar:443" && n.ServiceTargetType == "bar");

			payloadSender.FirstTransaction.DroppedSpanStats.Should()
				.Contain(n => n.Outcome == Outcome.Failure
					&& n.Duration.Count == 1 && Math.Abs(n.Duration.Sum.UsRaw - 50000) < 1 && n.DestinationServiceResource == "foo.bar:443"
					&& n.ServiceTargetName == "foo.bar:443" && n.ServiceTargetType == "bar");

			payloadSender.FirstTransaction.DroppedSpanStats.Should()
				.Contain(n => n.Outcome == Outcome.Success
					&& n.Duration.Count == 1 && Math.Abs(n.Duration.Sum.UsRaw - 15000) < 1 && n.DestinationServiceResource == "foo2.bar:443"
					&& n.ServiceTargetName == "foo2.bar:443" && n.ServiceTargetType == "bar");

			payloadSender.FirstTransaction.DroppedSpanStats.Should()
				.Contain(n => n.Outcome == Outcome.Success
					&& n.Duration.Count == 50 && Math.Abs(n.Duration.Sum.UsRaw - 50 * 50000) < 1 && n.DestinationServiceResource == "mysql");
		}
		...
		public void SimpleDroppedSpans()
		{
			...
			payloadSender.FirstTransaction.DroppedSpanStats.First().Duration.Count.Should().Be(500);
		}
	}
}
