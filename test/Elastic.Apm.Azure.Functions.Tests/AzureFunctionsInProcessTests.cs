...
[Collection("AzureFunctions-InProcess")]
public class AzureFunctionsInProcessTests : IClassFixture<AzureFunctionsTestFixtureInProcess>, IDisposable
{
	private readonly AzureFunctionsTestFixtureBase _azureFunctionsTestFixture;
	private readonly ITestOutputHelper _output;
	private static bool _isFirst = true;

	public AzureFunctionsInProcessTests(ITestOutputHelper output, AzureFunctionsTestFixtureInProcess azureFunctionsTestFixture)
	{
		_output = output;
	...
	private void Assert_MetaData(MetadataDto metaData)
	{
		...
		metaData.Service.Runtime.Name.Should().Be("dotnet");
