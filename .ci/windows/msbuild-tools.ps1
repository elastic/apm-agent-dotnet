...
& choco install visualstudio2019enterprise -m -y --no-progress --force -r --version=16.4.0.0 --package-parameters "--includeRecommended --includeOptional --add Microsoft.VisualStudio.Workload.WebBuildTools"
