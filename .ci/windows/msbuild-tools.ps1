...
& choco install visualstudio2019professional -m -y --no-progress --force -r --version=16.4.5.0 --package-parameters "--includeRecommended --includeOptional --add Microsoft.Component.MSBuild --add Microsoft.VisualStudio.Workload.WebBuildTools"
