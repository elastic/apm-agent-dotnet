...
public override void Init()
{
    ...
    Agenct.Subscribe(new SqlClientDiagnosticSubscriber());  /* Enable tracing of outgoing db requests */
}

----

NOTE: Auto intsrumentation for `System.Data.SqlClient` is available for both, .Net Core and .Net Framework applications, however, support of .Net Framework has one limitation:
