...
Furthermore, the agent offers the following configurations to automatically attach values from `Activity.Baggage` to:

* Transactions: <<config-baggage-to-attach-on-transactions, BaggageToAttachOnTransactions>>
* Spans: <<config-baggage-to-attach-on-spans, BaggageToAttachOnSpans>>
* Errors: <<config-baggage-to-attach-on-errors, BaggageToAttachOnErrors>>
