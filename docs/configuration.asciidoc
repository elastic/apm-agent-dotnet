...
This is used to know exact version of your service.

NOTE: The service version must conform to this regular expression: ^[0-9]+\.[0-9]+(?:\.[0-9]+)?(?:\.[0-9]+)?$. In less regexy terms: Your service version must contain only numbers (from 2 to 4), which are separated by `.` (dot).
...
|============
| Default                          | Type
| Version of the entry assembly    | Version 
|============
